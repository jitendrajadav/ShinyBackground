...
<xsl:stylesheet version="2.0"
                                        ...
                                        <div id="dateinfo">
                                            <span id="builddatetext">
                                                ...
                                                <xsl:call-template name="formatdatetime">
                                                    <xsl:with-param
                                                        name="datestr"
                                                        select="k:BuildDate"></xsl:with-param>
                                                </xsl:call-template>
                    ...
                    <td>
                        <div style="text-align: center">
                            ...
                            <div id="palletbarcode">
                                ...
                                <!-- 										http://barcodes4.me/barcode/qr/<xsl:value-of select="k:Barcode" />.png?value=<xsl:value-of select="k:Barcode" />&amp;size=6&amp;eccLevel=3 -->
                                <!-- 									</xsl:attribute> -->
                                <!-- 								</img> -->
                            </div>
                            <br/>
                            <div id="palletcode128">
                                ...
                                <!-- 								<img > -->
                                <!-- 									<xsl:attribute name="src"> -->
                                <!-- 										http://barcodes4.me/barcode/c128a/<xsl:value-of select="k:Barcode" />.png?width=350&amp;height=100&amp;IsTextDrawn=1 -->
                                <!-- 									</xsl:attribute> -->
                                <!-- 								</img> -->
                            </div>
                            <br/>
                    ...
                    <td style="width:40%">
                        ...
                        <div class="summarycontainer">
                            <table class="summarygrid">
                                ...
                                <tbody>
                                    <!--<xsl:apply-templates select="k:PalletItems"
                                                                mode="summary">
                                    </xsl:apply-templates>-->
                                    <xsl:apply-templates
                                        select="k:SummaryItems"
                                        mode="blah">
                                    </xsl:apply-templates>
                                </tbody>
                                <tfoot>
    ...
    <xsl:template
        match="k:SummaryItems"
        mode="blah">
        <xsl:for-each select="k:SummaryItem">
    ...
    <xsl:key
        name="summarykey"
        match="k:PalletItem/k:IsActive[text()='true']"
