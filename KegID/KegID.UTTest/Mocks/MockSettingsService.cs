...
{
    public class MockSettingsService : IAccountService
    {
        ...
        public Task<LoginResponseModel> AuthenticateAsync(string username, string password)
        {
            throw new NotImplementedException();
        }

        public Task<KegIDResponse> DeviceCheckinAsync(DeviceCheckinRequestModel inputModel, string sessionId, string RequestType)
        {
            throw new NotImplementedException();
        }
    }
